	...
	public void initArticlesCategories() {
		...
		if (listArticles.size() == 0) {
			...
			Article a7 = new Article(
					"Overwatch", "PC", cFps, "jeu blabla 7", 44, 40, LocalDate.of(2019, 12, 06), true,false,"Blizzard");
			Article a8 = new Article(
					"Control", "PS4", cAv, "jeu blabla 8", 44, 40, LocalDate.of(2019, 12, 24), true,false,"505 Games");
			Article a9 = new Article(
					"Doom Eternal", "PC", cAv, "jeu blabla 9", 44, 40, LocalDate.of(2020, 02, 12), false,false,"Bethesda");
			Article a10 = new Article(
					"Control", "XBOX", cAv, "jeu blabla 10", 44, 40, LocalDate.of(2019, 12, 24), true,false,"505 Games");
			Article a11 = new Article(
					"Rayman Legends", "SWITCH", cFps, "jeu blabla 11", 44, 40,
					LocalDate.of(2020, 01, 12), false,false,"Ubisoft");
			...
			Article a13 = new Article(
					"Halo 1", "XBOX", cSim, "jeu blabla 13", 44, 40, LocalDate.of(2020, 01, 12), true,false,"Microsoft");
			Article a14 = new Article(
					"Metal Gear Solid 4", "PS4", cSpo, "jeu blabla 14", 44, 40,
					LocalDate.of(2019, 12, 24), false,false,"Konami");
			Article a15 = new Article(
					"Portal 2", "PC", cFps, "jeu blabla 15", 44, 40, LocalDate.of(2019, 12, 31), true,true,"Valve");
